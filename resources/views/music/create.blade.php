            ...
            <form action="{{ route('music.store') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="url" id="url" name="url" value="{{ old('url') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    ...
                    <div>
                        <button type="submit" class="px-4 py-2 bg-blue-500 text-black rounded">Add Artist</button>
                    </div>
                </div>
            </form>
        </div>
